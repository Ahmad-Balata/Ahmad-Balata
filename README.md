...
### 🧠 What I Do
- 📊 Analyze, clean, and transform data for actionable insights
- 📈 Build interactive dashboards and visual reports
- 🧩 Work with **Excel, SQL, Python** to manage datasets
- 🚀 Continuously improve **BI & analytical skills**
...
- Optimizing **SQL queries & databases**
